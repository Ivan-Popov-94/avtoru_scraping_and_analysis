# команда для запуска
# scrapy runspider /home/ivan/WORK/PYTHON/studying/scrapy_spiders/avtoru/avtoru/spiders/avtoru_vaz_2114_spider.py
import os
import json
...
headers = {
    ...
    "Referer": "https://auto.ru/cars/vaz/2114/3913672/all/",
    "x-client-app-version": "6a285e532e",
    "x-page-request-id": "df0c8f6f0f7e9ea354be9d9cb0923c55",
    "x-client-date": "1609417707411",
...
class AvtoruSpider(Spider):
    ...
    def parse_first(self, response):
        filename = '/home/ivan/WORK/PYTHON/studying/scrapy_spiders/avtoru/responses/vaz_2114/response_page_1.json'
    ...
    def parse(self, response, page):
        filename = f'/home/ivan/WORK/PYTHON/studying/scrapy_spiders/avtoru/responses/vaz_2114/response_page_{page}.json'
        with open(filename, 'wb') as f:
            f.write(response.body)