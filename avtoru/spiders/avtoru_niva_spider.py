# scrapy runspider /home/ivan/WORK/PYTHON/studying/scrapy_spiders/avtoru/avtoru/spiders/avtoru_niva_spider.py
import os
import json
...
headers = {
    ...
    "Referer": "https://auto.ru/cars/all/?catalog_filter=mark%3DVAZ%2Cmodel%3D2121%2Cgeneration%3D2307327&catalog_filter=mark%3DVAZ%2Cmodel%3DNIVA&engine_group=GASOLINE",
    "x-client-app-version": "6a285e532e",
    "x-page-request-id": "60877ba5c6d9550d7a600265af092b94",
    "x-client-date": "1609446747375",
...
class AvtoruSpider(Spider):
    ...
    def parse_first(self, response):
        filename = '/home/ivan/WORK/PYTHON/studying/scrapy_spiders/avtoru/responses/niva/response_page_1.json'
    ...
    def parse(self, response, page):
        filename = f'/home/ivan/WORK/PYTHON/studying/scrapy_spiders/avtoru/responses/niva/response_page_{page}.json'
        with open(filename, 'wb') as f:
            f.write(response.body)