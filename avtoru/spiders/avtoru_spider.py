...
headers = {
    ...
    "Referer": "https://auto.ru/cars/honda/cr_v/2306830/all/?transmission=AUTOMATIC&page=1",
    "x-client-app-version": "6a285e532e",
    "x-page-request-id": "df0c8f6f0f7e9ea354be9d9cb0923c55",
    "x-client-date": "1609395573100",
...
class AvtoruSpider(Spider):
    ...
    def parse_first(self, response):
        filename = '/home/ivan/WORK/PYTHON/studying/scrapy_spiders/avtoru/responses/response_page_1.json'
    ...
    def parse(self, response, page):
        filename = f'/home/ivan/WORK/PYTHON/studying/scrapy_spiders/avtoru/responses/response_page_{page}.json'
        with open(filename, 'wb') as f:
            f.write(response.body)